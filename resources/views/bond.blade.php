...
<body>
      ...
      <div class="offcanvas offcanvas-end text-bg-Light" tabindex="-1" id="offcanvasLightNavbar" aria-labelledby="offcanvasLightNavbarLabel">
        ...
        <div class="offcanvas-body">
          <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="/bond"><i class="bi bi-piggy-bank-fill"></i> Bond</a>
            </li>
            <li class="nav-item">
  ...
  <div class="info">
    ...
    @endif
      <a href="/buatbond"> <button class="btn btn-info"> Buat Baru</button> </a>
      <table class="table table-hover">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{ $u->status }}</td>
            <td>
              <a href="/lunasibond/{{ $u->id }}" class="btn btn-success" method="POST">
                Lunasi</a>
              <form action="{{ route('bond.destroy', $u->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
                @csrf
                @method('DELETE')
