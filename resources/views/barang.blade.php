...
<body>
      ...
      <div class="offcanvas offcanvas-end text-bg-Light" tabindex="-1" id="offcanvasLightNavbar" aria-labelledby="offcanvasLightNavbarLabel">
        ...
        <div class="offcanvas-body">
          <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="/barang"><i class="bi bi-bag-heart-fill"></i> Barang</a>
            </li>
            <li class="nav-item">
  ...
  <div class="info">
    <div class="content">
      ...
      @endif
      <a href="/buatbarang"> <button class="btn btn-info"> Buat Baru</button> </a>
      <table class="table table-hover">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{ $u->harga }}</td>
            <td>
              <a href="editbarang/{{ $u->id }}" class="btn btn-warning" method="POST">
                Ubah</a>
            </td>
            <td>
              <form action="{{ route('barang.destroy', $u->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
                @csrf
                @method('DELETE')
