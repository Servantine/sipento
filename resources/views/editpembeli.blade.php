    ...
    <div class="info">
        <div class="content">
            <div class="form-control">
                <form action="/saveeditpembeli/ {{ $pembeli->id }}" method="PUT" id="formpembeli">
                    @csrf
                    <br>
                    ...
                    <br>
                    <br>
                    <input type="text" class="form-control" name="namapembeli" value="{{ $pembeli->namapembeli }}" required>
                    <br>
                    <br>
                    <b> No HP </b>
                    <br>
                    <br>
                    <input type="text" class="form-control" name="nohp" value="{{ $pembeli->nohp }}" required>
                    <br>
                    <br>
